...
public class CoupledGearPredictorCorrector5Solution implements Iterator<State> {
    ...
    public CoupledGearPredictorCorrector5Solution(double b, double k, double mass, double maxTime, double timestep, double initialAmplitud, State initialState) {
        this.b = b;
        this.k = k;
        this.mass = mass;
