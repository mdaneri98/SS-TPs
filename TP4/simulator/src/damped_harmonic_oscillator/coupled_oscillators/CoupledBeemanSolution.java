...
public class CoupledBeemanSolution implements Iterator<State> {
    ...
    public CoupledBeemanSolution(double b, double k, double maxTime, double timestep, State initialState) {
        this.b = b;
        this.k = k;
