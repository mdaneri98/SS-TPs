...
Los resultados muestran que cuando el sistema prioriza la distancia (p → 1), se obtienen tiempos de evacuación más cortos, aproximadamente 80 segundos, pero a costa de una marcada congestión en las salidas más cercanas y una distribución desigual del flujo. En contraste, cuando el sistema prioriza la densidad (p → 0), los tiempos de evacuación se extienden hasta aproximadamente 250 segundos, pero se logra una distribución más equilibrada entre las salidas y una menor congestión en cada puerta individual.
El tiempo de re-decisión también juega un papel crucial en la dinámica del sistema. Intervalos cortos de re-decisión promueven una mayor uniformidad en el uso de las salidas, pero pueden resultar en evacuaciones más lentas debido al constante cambio de objetivo por parte de los agentes. Por otro lado, tiempos más largos de re-decisión conducen a evacuaciones más rápidas pero con mayor concentración en ciertas salidas.
Los resultados sugieren que un valor intermedio del parámetro de ponderación (p ≈ 0.5) ofrece el mejor compromiso entre tiempo total de evacuación, uniformidad en el uso de salidas y niveles de congestión manejables. Esta configuración permite que los agentes consideren tanto la proximidad de las salidas como la densidad de personas en cada una, resultando en un comportamiento más equilibrado.
